...
| Matheus      | Visualização, `app.py`, integração, experimentos, LLM e testes e2e |
| João Victor  | Infraestrutura, documentação e vídeo |

---

## Resultados

- **21 pontos de entrega**, 3 veículos
- Distância inicial → otimizada: **melhoria média de ~18-22%** (varia por configuração)
...
> **Link:** *(adicionar link do YouTube/Drive após upload)*
